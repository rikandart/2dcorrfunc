#ifndef __G33DDCAPI_H__
#define __G33DDCAPI_H__
...
#define __G3XDDC_FRONT_PANEL_LED__ 3
...
#define G33DDC_MODE_COUNT            9



#ifndef __G3XDDC_SIDE_BAND__
#define __G3XDDC_SIDE_BAND__ 3
...
#define __G3XDDC_DEMODULATOR_PARAMS__ 3
...
#define __G3XDDC_DEMODULATOR_STATES__ 3
...
#undef INTERFACE
#define INTERFACE IG33DDCDeviceEnumerator

DECLARE_INTERFACE(IG33DDCDeviceEnumerator)
{
    ...
    STDMETHOD_(BOOL,GetDeviceInfo)(THIS_ UINT32 DeviceIndex,G33DDC_DEVICE_INFO *DeviceInfo,UINT32 BufferLength) PURE;
};

#undef INTERFACE
#define INTERFACE IG33DDCDeviceCallback

struct IG33DDCDevice;

DECLARE_INTERFACE(IG33DDCDeviceCallback)
{
    STDMETHOD_(VOID,G33DDC_IFCallback)(THIS_ struct IG33DDCDevice *Device,CONST SHORT *Buffer,UINT32 NumberOfSamples,WORD MaxADCAmplitude,UINT32 ADCSamplingRate) PURE;
    STDMETHOD_(VOID,G33DDC_DDC1StreamCallback)(THIS_ struct IG33DDCDevice *Device,CONST VOID *Buffer,UINT32 NumberOfSamples,UINT32 BitsPerSample) PURE;
    STDMETHOD_(BOOL,G33DDC_DDC1PlaybackStreamCallback)(THIS_ struct IG33DDCDevice *Device,VOID *Buffer,UINT32 NumberOfSamples,UINT32 BitsPerSample) PURE;
    STDMETHOD_(VOID,G33DDC_DDC2StreamCallback)(THIS_ struct IG33DDCDevice *Device,UINT32 Channel,CONST FLOAT *Buffer,UINT32 NumberOfSamples) PURE;        
    ...
    STDMETHOD_(VOID,G33DDC_DDC2PreprocessedStreamCallback)(THIS_ struct IG33DDCDevice *Device,UINT32 Channel,CONST FLOAT *Buffer,UINT32 NumberOfSamples,FLOAT SlevelPeak,FLOAT SlevelRMS) PURE;        
    STDMETHOD_(VOID,G33DDC_AudioStreamCallback)(THIS_ struct IG33DDCDevice *Device,UINT32 Channel,CONST FLOAT *Buffer,CONST FLOAT *BufferFiltered,UINT32 NumberOfSamples) PURE;
    STDMETHOD_(BOOL,G33DDC_AudioPlaybackStreamCallback)(THIS_ struct IG33DDCDevice *Device,UINT32 Channel,FLOAT *Buffer,UINT32 NumberOfSamples) PURE;
};

#undef INTERFACE
#define INTERFACE IG33DDCDevice


DECLARE_INTERFACE(IG33DDCDevice)
{
    STDMETHOD_(LONG,AddRef)(THIS) PURE;
    STDMETHOD_(LONG,Release)(THIS) PURE;
    ...
    STDMETHOD_(VOID,SetCallback)(THIS_ IG33DDCDeviceCallback *Callback) PURE;
    STDMETHOD_(IG33DDCDeviceCallback*,GetCallback)(THIS) PURE;

    STDMETHOD_(BOOL,GetDeviceInfo)(THIS_ G33DDC_DEVICE_INFO *Info,UINT32 BufferLength) PURE;
    ...
    STDMETHOD_(BOOL,SetSpreading)(THIS_ BOOL Enabled) PURE;
    STDMETHOD_(BOOL,GetSpreading)(THIS_ BOOL *Enabled) PURE;
...
//GetDeviceList
typedef INT32 (__stdcall *G33DDC_GET_DEVICE_LIST)(G33DDC_DEVICE_INFO *DeviceList,UINT32 BufferSize);
//OpenDevice
typedef INT32(__stdcall *G33DDC_OPEN_DEVICE)(CONST CHAR *SerialNumber);
//CloseDevice
typedef BOOL (__stdcall *G33DDC_CLOSE_DEVICE)(INT32 hDevice);
//IsDeviceConnected
typedef BOOL (__stdcall *G33DDC_IS_DEVICE_CONNECTED)(INT32 hDevice);
//GetDeviceInfo
typedef BOOL (__stdcall *G33DDC_GET_DEVICE_INFO)(INT32 hDevice,G33DDC_DEVICE_INFO *Info,UINT32 BufferLength);
//SetPower
typedef BOOL (__stdcall *G33DDC_SET_POWER)(INT32 hDevice,BOOL Power);
//GetPower
typedef BOOL (__stdcall *G33DDC_GET_POWER)(INT32 hDevice,BOOL *Power);
//SetAttenuator
typedef BOOL (__stdcall *G33DDC_SET_ATTENUATOR)(INT32 hDevice,UINT32 Attenuator);
//GetAttenuator
typedef BOOL (__stdcall *G33DDC_GET_ATTENUATOR)(INT32 hDevice,UINT32 *Attenuator);
//SetDithering
typedef BOOL (__stdcall *G33DDC_SET_DITHERING)(INT32 hDevice,BOOL Enabled);
//GetDithering
typedef BOOL (__stdcall *G33DDC_GET_DITHERING)(INT32 hDevice,BOOL *Enabled);
//SetPreamp
typedef BOOL (__stdcall *G33DDC_SET_PREAMP)(INT32 hDevice,BOOL Preamp);
//GetPreamp
typedef BOOL (__stdcall *G33DDC_GET_PREAMP)(INT32 hDevice,BOOL *Preamp);
//SetPreselectors
typedef BOOL (__stdcall *G33DDC_SET_PRESELECTORS)(INT32 hDevice,UINT32 Low,UINT32 High);
//GetPreselectors
typedef BOOL (__stdcall *G33DDC_GET_PRESELECTORS)(INT32 hDevice,UINT32 *Low,UINT32 *High);
//SetLED
typedef BOOL (__stdcall *G33DDC_SET_LED)(INT32 hDevice,UINT32 LEDMode);
//GetLED
typedef BOOL (__stdcall *G33DDC_GET_LED)(INT32 hDevice,UINT32 *LEDMode);
//SetInverted    
typedef BOOL (__stdcall *G33DDC_SET_INVERTED)(INT32 hDevice,BOOL Inverted);
//GetInverted    
typedef BOOL (__stdcall *G33DDC_GET_INVERTED)(INT32 hDevice,BOOL *Inverted);
//SetADCNoiseBlanker
typedef BOOL (__stdcall *G33DDC_SET_ADC_NOISE_BLANKER)(INT32 hDevice,BOOL Enabled);
//GetADCNoiseBlanker
typedef BOOL (__stdcall *G33DDC_GET_ADC_NOISE_BLANKER)(INT32 hDevice,BOOL *Enabled);
//SetADCNoiseBlankerThreshold
typedef BOOL (__stdcall *G33DDC_SET_ADC_NOISE_BLANKER_THRESHOLD)(INT32 hDevice,WORD Threshold);
//GetADCNoiseBlankerThreshold
typedef BOOL (__stdcall *G33DDC_GET_ADC_NOISE_BLANKER_THRESHOLD)(INT32 hDevice,WORD *Threshold);
//StartIF
typedef BOOL (__stdcall *G33DDC_START_IF)(INT32 hDevice,WORD Period);
//StopIF
typedef BOOL (__stdcall *G33DDC_STOP_IF)(INT32 hDevice);
//GetDDCInfo
typedef BOOL (__stdcall *G33DDC_GET_DDC_INFO)(INT32 hDevice,UINT32 DDCTypeIndex,G3XDDC_DDC_INFO *Info);
//GetDDC1Count
typedef BOOL (__stdcall *G33DDC_GET_DDC1_COUNT)(INT32 hDevice,UINT32 *Count);
//SetDDC1
typedef BOOL (__stdcall *G33DDC_SET_DDC1)(INT32 hDevice,UINT32 DDCTypeIndex);
//GetDDC1
typedef BOOL (__stdcall *G33DDC_GET_DDC1)(INT32 hDevice,UINT32 *DDCTypeIndex,G3XDDC_DDC_INFO *DDCInfo);
//StartDDC1
typedef BOOL (__stdcall *G33DDC_START_DDC1)(INT32 hDevice,UINT32 SamplesPerBuffer);
//StopDDC1
typedef BOOL (__stdcall *G33DDC_STOP_DDC1)(INT32 hDevice);
//StartDDC1Playback
typedef BOOL (__stdcall *G33DDC_START_DDC1_PLAYBACK)(INT32 hDevice,UINT32 SamplesPerBuffer,UINT32 BitsPerSample);
//PauseDDC1Playback
typedef BOOL (__stdcall *G33DDC_PAUSE_DDC1_PLAYBACK)(INT32 hDevice);
//ResumeDDC1Playback
typedef BOOL (__stdcall *G33DDC_RESUME_DDC1_PLAYBACK)(INT32 hDevice);
//SetDDC1Frequency
typedef BOOL (__stdcall *G33DDC_SET_DDC1_FREQUENCY)(INT32 hDevice,UINT32 Frequency);
//GetDDC1Frequency
typedef BOOL (__stdcall *G33DDC_GET_DDC1_FREQUENCY)(INT32 hDevice,UINT32 *Frequency);
//GetDDC2
typedef BOOL (__stdcall *G33DDC_GET_DDC2)(INT32 hDevice,UINT32 *DDCTypeIndex,G3XDDC_DDC_INFO *DDCInfo);
//StartDDC2
typedef BOOL (__stdcall *G33DDC_START_DDC2)(INT32 hDevice,UINT32 Channel,UINT32 SamplesPerBuffer);
//StopDDC2
typedef BOOL (__stdcall *G33DDC_STOP_DDC2)(INT32 hDevice,UINT32 Channel);
//SetDDC2Frequency
typedef BOOL (__stdcall *G33DDC_SET_DDC2_FREQUENCY)(INT32 hDevice,UINT32 Channel,INT32 Frequency);
//GetDDC2Frequency
typedef BOOL (__stdcall *G33DDC_GET_DDC2_FREQUENCY)(INT32 hDevice,UINT32 Channel,INT32 *Frequency);
//SetDDC2NoiseBlanker
typedef BOOL (__stdcall *G33DDC_SET_DDC2_NOISE_BLANKER)(INT32 hDevice,UINT32 Channel,BOOL Enabled);
//GetDDC2NoiseBlanker
typedef BOOL (__stdcall *G33DDC_GET_DDC2_NOISE_BLANKER)(INT32 hDevice,UINT32 Channel,BOOL *Enabled);
//SetDDC2NoiseBlankerThreshold
typedef BOOL (__stdcall *G33DDC_SET_DDC2_NOISE_BLANKER_THRESHOLD)(INT32 hDevice,UINT32 Channel,double Threshold);
//GetDDC2NoiseBlankerThreshold
typedef BOOL (__stdcall *G33DDC_GET_DDC2_NOISE_BLANKER_THRESHOLD)(INT32 hDevice,UINT32 Channel,double *Threshold);
//GetDDC2NoiseBlankerExcessValue
typedef BOOL (__stdcall *G33DDC_GET_DDC2_NOISE_BLANKER_EXCESS_VALUE)(INT32 hDevice,UINT32 Channel,double *Value);
//GetSignalLevel
typedef BOOL (__stdcall *G33DDC_GET_SIGNAL_LEVEL)(INT32 hDevice,UINT32 Channel,FLOAT *Peak,FLOAT *RMS);
//SetAGC
typedef BOOL (__stdcall *G33DDC_SET_AGC)(INT32 hDevice,UINT32 Channel,BOOL Enabled);
//GetAGC
typedef BOOL (__stdcall *G33DDC_GET_AGC)(INT32 hDevice,UINT32 Channel,BOOL *Enabled);
//SetAGCParams
typedef BOOL (__stdcall *G33DDC_SET_AGC_PARAMS)(INT32 hDevice,UINT32 Channel,double AttackTime,double DecayTime,double ReferenceLevel);
//GetAGCParams
typedef BOOL (__stdcall *G33DDC_GET_AGC_PARAMS)(INT32 hDevice,UINT32 Channel,double *AttackTime,double *DecayTime,double *ReferenceLevel);
//SetMaxAGCGain
typedef BOOL (__stdcall *G33DDC_SET_MAX_AGC_GAIN)(INT32 hDevice,UINT32 Channel,double MaxGain);
//GetMaxAGCGain
typedef BOOL (__stdcall *G33DDC_GET_MAX_AGC_GAIN)(INT32 hDevice,UINT32 Channel,double *MaxGain);
//SetGain
typedef BOOL (__stdcall *G33DDC_SET_GAIN)(INT32 hDevice,UINT32 Channel,double Gain);
//GetGain
typedef BOOL (__stdcall *G33DDC_GET_GAIN)(INT32 hDevice,UINT32 Channel,double *Gain);
//GetCurrentGain
typedef BOOL (__stdcall *G33DDC_GET_CURRENT_GAIN)(INT32 hDevice,UINT32 Channel,double *Gain);
//SetNotchFilter
typedef BOOL (__stdcall *G33DDC_SET_NOTCH_FILTER)(INT32 hDevice,UINT32 Channel,UINT32 NotchFilterIndex,BOOL Enabled);
//GetNotchFilter
typedef BOOL (__stdcall *G33DDC_GET_NOTCH_FILTER)(INT32 hDevice,UINT32 Channel,UINT32 NotchFilterIndex,BOOL *Enabled);
//SetNotchFilterFrequency
typedef BOOL (__stdcall *G33DDC_SET_NOTCH_FILTER_FREQUENCY)(INT32 hDevice,UINT32 Channel,UINT32 NotchFilterIndex,INT32 Frequency);
//GetNotchFilterFrequency
typedef BOOL (__stdcall *G33DDC_GET_NOTCH_FILTER_FREQUENCY)(INT32 hDevice,UINT32 Channel,UINT32 NotchFilterIndex,INT32 *Frequency);
//SetNotchFilterBandwidth
typedef BOOL (__stdcall *G33DDC_SET_NOTCH_FILTER_BANDWIDTH)(INT32 hDevice,UINT32 Channel,UINT32 NotchFilterIndex,UINT32 Bandwidth);
//GetNotchFilterBandwidth
typedef BOOL (__stdcall *G33DDC_GET_NOTCH_FILTER_BANDWIDTH)(INT32 hDevice,UINT32 Channel,UINT32 NotchFilterIndex,UINT32 *Bandwidth);
//SetNotchFilterLength
typedef BOOL (__stdcall *G33DDC_SET_NOTCH_FILTER_LENGTH)(INT32 hDevice,UINT32 Channel,UINT32 NotchFilterIndex,UINT32 Length);
//GetNotchFilterLength
typedef BOOL (__stdcall *G33DDC_GET_NOTCH_FILTER_LENGTH)(INT32 hDevice,UINT32 Channel,UINT32 NotchFilterIndex,UINT32 *Length);
//SetDemodulatorMode
typedef BOOL (__stdcall *G33DDC_SET_DEMODULATOR_MODE)(INT32 hDevice,UINT32 Channel,UINT32 Mode);
//GetDemodulatorMode
typedef BOOL (__stdcall *G33DDC_GET_DEMODULATOR_MODE)(INT32 hDevice,UINT32 Channel,UINT32 *Mode);
//SetDemodulatorFrequency
typedef BOOL (__stdcall *G33DDC_SET_DEMODULATOR_FREQUENCY)(INT32 hDevice,UINT32 Channel,INT32 Frequency);
//GetDemodulatorFrequency
typedef BOOL (__stdcall *G33DDC_GET_DEMODULATOR_FREQUENCY)(INT32 hDevice,UINT32 Channel,INT32 *Frequency);
//SetDemodulatorFilterBandwidth
typedef BOOL (__stdcall *G33DDC_SET_DEMODULATOR_FILTER_BANDWIDTH)(INT32 hDevice,UINT32 Channel,UINT32 Bandwidth);
//GetDemodulatorFilterBandwidth
typedef BOOL (__stdcall *G33DDC_GET_DEMODULATOR_FILTER_BANDWIDTH)(INT32 hDevice,UINT32 Channel,UINT32 *Bandwidth);
//SetDemodulatorFilterShift
typedef BOOL (__stdcall *G33DDC_SET_DEMODULATOR_FILTER_SHIFT)(INT32 hDevice,UINT32 Channel,INT32 Shift);
//GetDemodulatorFilterShift
typedef BOOL (__stdcall *G33DDC_GET_DEMODULATOR_FILTER_SHIFT)(INT32 hDevice,UINT32 Channel,INT32 *Shift);
//SetDemodulatorFilterLength
typedef BOOL (__stdcall *G33DDC_SET_DEMODULATOR_FILTER_LENGTH)(INT32 hDevice,UINT32 Channel,UINT32 Length);
//GetDemodulatorFilterLength
typedef BOOL (__stdcall *G33DDC_GET_DEMODULATOR_FILTER_LENGTH)(INT32 hDevice,UINT32 Channel,UINT32 *Length);
//SetDemodulatorParam
typedef BOOL (__stdcall *G33DDC_SET_DEMODULATOR_PARAM)(INT32 hDevice,UINT32 Channel,UINT32 Code,CONST VOID *Buffer,UINT32 BufferSize);
//GetDemodulatorParam
typedef BOOL (__stdcall *G33DDC_GET_DEMODULATOR_PARAM)(INT32 hDevice,UINT32 Channel,UINT32 Code,VOID *Buffer,UINT32 BufferSize);
//GetDemodulatorState
typedef BOOL (__stdcall *G33DDC_GET_DEMODULATOR_STATE)(INT32 hDevice,UINT32 Channel,UINT32 Code,VOID *Buffer,UINT32 BufferSize);
//StartAudio
typedef BOOL (__stdcall *G33DDC_START_AUDIO)(INT32 hDevice,UINT32 Channel,UINT32 SamplesPerBuffer);
//StopAudio
typedef BOOL (__stdcall *G33DDC_STOP_AUDIO)(INT32 hDevice,UINT32 Channel);
//StartAudioPlayback
typedef BOOL (__stdcall *G33DDC_START_AUDIO_PLAYBACK)(INT32 hDevice,UINT32 Channel,UINT32 SamplesPerBuffer);
//PauseAudioPlayback
typedef BOOL (__stdcall *G33DDC_PAUSE_AUDIO_PLAYBACK)(INT32 hDevice,UINT32 Channel);
//ResumeAudioPlayback
typedef BOOL (__stdcall *G33DDC_RESUME_AUDIO_PLAYBACK)(INT32 hDevice,UINT32 Channel);
//SetAudioFilter
typedef BOOL (__stdcall *G33DDC_SET_AUDIO_FILTER)(INT32 hDevice,UINT32 Channel,BOOL Enabled);
//GetAudioFilter
typedef BOOL (__stdcall *G33DDC_GET_AUDIO_FILTER)(INT32 hDevice,UINT32 Channel,BOOL *Enabled);
//SetAudioFilterParams
typedef BOOL (__stdcall *G33DDC_SET_AUDIO_FILTER_PARAMS)(INT32 hDevice,UINT32 Channel,UINT32 CutOffLow,UINT32 CutOffHigh,double Deemphasis);
//GetAudioFilterParams
typedef BOOL (__stdcall *G33DDC_GET_AUDIO_FILTER_PARAMS)(INT32 hDevice,UINT32 Channel,UINT32 *CutOffLow,UINT32 *CutOffHigh,double *Deemphasis);
//SetAudioFilterLength
typedef BOOL (__stdcall *G33DDC_SET_AUDIO_FILTER_LENGTH)(INT32 hDevice,UINT32 Channel,UINT32 Length);
//GetAudioFilterLength
typedef BOOL (__stdcall *G33DDC_GET_AUDIO_FILTER_LENGTH)(INT32 hDevice,UINT32 Channel,UINT32 *Length);
//SetAudioGain
typedef BOOL (__stdcall *G33DDC_SET_AUDIO_GAIN)(INT32 hDevice,UINT32 Channel,double Gain);
//GetAudioGain
typedef BOOL (__stdcall *G33DDC_GET_AUDIO_GAIN)(INT32 hDevice,UINT32 Channel,double *Gain);
//SetDRMKey
typedef BOOL (__stdcall *G33DDC_SET_DRM_KEY)(INT32 hDevice,CONST CHAR *DRMKeyFileDirectory);
//IsDRMUnlocked
typedef BOOL (__stdcall *G33DDC_IS_DRM_UNLOCKED)(INT32 hDevice);
//GetSpectrumCompensation
typedef BOOL (__stdcall *G33DDC_GET_SPECTRUM_COMPENSATION)(INT32 hDevice,UINT64 CenterFrequency,UINT32 Width,FLOAT *Buffer,UINT32 Count);
//SetFrequency
typedef BOOL (__stdcall *G33DDC_SET_FREQUENCY)(INT32 hDevice,UINT32 Channel,UINT32 Frequency);
//GetFrequency
typedef BOOL (__stdcall *G33DDC_GET_FREQUENCY)(INT32 hDevice,UINT32 Channel,UINT32 *Frequency);
//SetCallbacks
typedef BOOL (__stdcall *G33DDC_SET_CALLBACKS)(INT32 hDevice,CONST G33DDC_CALLBACKS *Callbacks,DWORD_PTR UserData);
